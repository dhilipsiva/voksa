...
5. Create an annotated tag `phase$0-complete`. The auto-push hook pushes the commit and tag to origin; confirm they landed with `git ls-remote --heads --tags origin`.
