...
/// Targets from docs/formants.md: F1 730, F2 1090, F3 2440 Hz.
pub fn steady_a_schedule(sample_rate: u32) -> Schedule {
    // TODO(red checkpoint): real /a/ targets land after the failing
    // acceptance test is committed. An empty schedule renders silence
    // (klattsch Params::DEFAULT has voicing 0 and a1..a3 0).
    Schedule::empty(sample_rate)
}
