//! The tuning column: prosody + naturalness side by side, then the
//! attitudinals and voice-table master-detail sections. Whole-config controls
//! (preset / reset-all / import / export) live in the left column's ConfigCard
//! (C7); there is no rack-nav.
